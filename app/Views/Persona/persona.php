    ...
    <div class="page-title-wrapper">
        ...
        <div class="page-title-actions">
            <?php if (session()->get('admin') == 1) : ?>
                <button type="button" class="btn-shadow btn btn-primary" data-toggle="modal" data-target="#persona-agregar-modal">
...
<?= $this->endSection() ?>
<?= $this->section('modals') ?>
<?= $this->include('Persona/persona_agregar') ?>
